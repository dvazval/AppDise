...
class CreateIngrediente(ModelForm):
	...
	idingrediente = forms.ChoiceField(choices=[ (o.idingrediente.idingrediente, 'Articulo'  ) for o in IngredienteXReceta.objects.select_related().filter(idreceta=self.receta)])
