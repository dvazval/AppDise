...
class CreateIngrediente(ModelForm):
	...
	idingrediente = forms.ChoiceField(choices=[ (o.idingrediente, o.idingrediente.articulo  ) for o in IngredienteXReceta.objects.select_related().filter(idreceta=self.receta)])
